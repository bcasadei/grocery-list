...
$(document).ready(function() {
    ...
    function newList() {
        ...
        $(".list-holder").append("<div class='list'>" +
            ...
            "<div class='row'><p><i class='fa fa-square-o'></i> <input id='item' placeholder='Enter item name…'> <i class='fa fa-times-circle add-item'></i></p></div>" +
            "</div>");
    ...
    $(document).on( "keyup", ("#item"), function(event) {
        if(event.which == 13) {
            ...
            $(this).closest('.list').append("<div class='row'><p><i class='fa fa-square-o'></i> <input id='item' placeholder='Enter item name…'> <i class='fa fa-times-circle add-item'></i></p></div>");
            event.preventDefault();
        }
    });
    /* Clear lists */
